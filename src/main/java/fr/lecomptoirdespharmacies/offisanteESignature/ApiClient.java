package fr.lecomptoirdespharmacies.offisanteESignature;
...
import fr.lecomptoirdespharmacies.offisanteESignature.auth.HttpBasicAuth;
import fr.lecomptoirdespharmacies.offisanteESignature.auth.HttpBearerAuth;
import fr.lecomptoirdespharmacies.offisanteESignature.auth.ApiKeyAuth;
import fr.lecomptoirdespharmacies.offisanteESignature.ApiResponseDecoder;
...
public class ApiClient {
  ...
  private String basePath = "https://get-accept-dev.offisante.fr";
  ...
  public ApiClient(String[] authNames) {
    ...
    for(String authName : authNames) {
      ...
      if ("access_auth".equals(authName)) {
        auth = new ApiKeyAuth("header", "x-access-token");
      } else {
